...
public class AYs_Dashboard_Clearance extends Fragment {
...
HomeAdapter homeAdapter;
    ...
    public static AYs_Dashboard_Clearance newInstance() {
        return new AYs_Dashboard_Clearance();
    }
