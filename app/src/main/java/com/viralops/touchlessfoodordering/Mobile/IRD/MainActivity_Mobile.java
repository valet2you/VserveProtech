...
dispachedlayout=findViewById(R.id.eventlayout1);
        ...
        newcountevent1.setTypeface(Typeface.defaultFromStyle(Typeface.BOLD));
        orders=findViewById(R.id.event);
        orders1=findViewById(R.id.event1);
        orders.setTypeface(Typeface.defaultFromStyle(Typeface.BOLD));
        orders1.setTypeface(Typeface.defaultFromStyle(Typeface.BOLD));
...
//
        ...
        if (savedInstanceState == null) {
            ...
            orders1.setTextColor(Color.parseColor("#6E7E7E"));
            ...
            dispachedlayout.setBackgroundColor(getResources().getColor(R.color.white));
    ...
    public void onClick(View view) {
        ...
        if(view.getId()== R.id.eventlayout1){
            isvisisble=false;

            Fragment fragmentmanager = new Associate_Dashboard_dispatched();
            getSupportFragmentManager().beginTransaction()
                    .replace(R.id.rootLayout, fragmentmanager, fragmentmanager.getClass().getSimpleName()).addToBackStack(null).commit();

            orders1.setTextColor(MainActivity_Mobile.this.getResources().getColor(R.color.darkblue));
            home.setTextColor(Color.parseColor("#6E7E7E"));
            orders.setTextColor(Color.parseColor("#6E7E7E"));
            homelayout.setBackgroundColor(getResources().getColor(R.color.white));
            dispachedlayout.setBackgroundColor(getResources().getColor(R.color.white));
