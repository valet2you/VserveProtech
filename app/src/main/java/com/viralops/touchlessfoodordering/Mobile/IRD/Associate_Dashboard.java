...
public class Associate_Dashboard extends Fragment {
...
*/
  ...
  /*      recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                if(AssociateMain.homeicon.getVisibility()==View.VISIBLE) {
                    ...
                    if(MainActivity_Mobile.homeicon.getVisibility()==View.VISIBLE){
                        try {
                            if (MainActivity_Mobile.shake != null) {
                                MainActivity_Mobile.shake.cancel();

                                MainActivity_Mobile.homeicon.setVisibility(View.GONE);
                            }
                        }
                        catch (Exception e){
