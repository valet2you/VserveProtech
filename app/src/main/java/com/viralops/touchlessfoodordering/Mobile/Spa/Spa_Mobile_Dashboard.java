...
import com.viralops.touchlessfoodordering.Mobile.Laundry.Laundry_Dashboard_Clearance;
...
public class Spa_Mobile_Dashboard extends Fragment {
...
*/
  ...
  /*      recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                if(Spa_Mobile.homeicon.getVisibility()==View.VISIBLE) {
        ...
        (RetrofitClientInstance.getApiService().Spa_OrderAccepted(BuildConfig.spa_order_accept+id,"Bearer "+sessionManager.getACCESSTOKEN())).enqueue(new Callback<Action>() {
            ...
            public void onResponse(@NonNull Call<Action> call, @NonNull Response<Action> response) {
                ...
                if(response.code()==202||response.code()==200){
                    ...
                    if(Spa_Mobile.homeicon.getVisibility()==View.VISIBLE){
                        try {
                            if (Spa_Mobile.shake != null) {
                                Spa_Mobile.shake.cancel();
                                Spa_Mobile.homeicon.setVisibility(View.GONE);
                            }
                        }
                        catch (Exception e){
...
*/
        ...
        (RetrofitClientInstance.getApiService().Spa_OrderCleared(BuildConfig.spa_order_clear+id,"Bearer "+sessionManager.getACCESSTOKEN(),"","")).enqueue(new Callback<Action>() {
            @Override
            public void onResponse(@NonNull Call<Action> call, @NonNull Response<Action> response) {
...
//If you need time just put specific format for time like 'HH:mm:ss'
    ...
    private void filter(String text) {
        ...
        for (Spa_dashboard.Data s :queuelistnew) {
