...
public class Connect_Fragmentcombine extends Fragment {
    private Ringtone r;
    ...
    public static Connect_Fragmentcombine newInstance() {
        return new Connect_Fragmentcombine();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
       ...
       if(Network.isNetworkAvailable(getActivity())){
        ...
        try {
            MainActivity.newordersconnect.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (queuelist.size() != 0) {
                        try {
                            if(MainActivity.bellconnect.getVisibility()==v.VISIBLE) {
        ...
        shimmerRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                if(MainActivity.bellconnect.getVisibility()==View.GONE) {
        ...
        (RetrofitClientInstance.getApiService().Connect_getHeader("Bearer "+sessionManager.getACCESSTOKEN())).enqueue(new Callback<Connect_Header>() {
            ...
            public void onResponse(@NonNull Call<Connect_Header> call, @NonNull Response<Connect_Header> response) {
                ...
                if(response.code()==202||response.code()==200){
                    ...
                    MainActivity.newtotalconnect.setText(String.valueOf(login.getData().getNew_order()));
                    MainActivity.totalorderconnect.setText(String.valueOf(login.getData().getToday_order()));
                    MainActivity.inprogresstotal.setText(String.valueOf(login.getData().getToday_order()));
