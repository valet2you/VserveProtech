...
import com.viralops.touchlessfoodordering.Mobile.Restaurant.Restaurant_Dashboard_Clearance;
...
public class RestuartAppMainFragmentAccepted extends Fragment implements View.OnClickListener {
    private Ringtone r;
    ...
    public static RestuartAppMainFragmentAccepted newInstance() {
        return new RestuartAppMainFragmentAccepted();
    }
...
searchView.setHint("Search for Table No. or Order No.");
        ...
        try {
            Resturant_Tablet_MainActivity.neworderss.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (queuelist.size() != 0) {
                        try {
                            if(Resturant_Tablet_MainActivity.imgBell.getVisibility()==v.VISIBLE) {
        ...
        shimmerRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                if(Resturant_Tablet_MainActivity.imgBell.getVisibility()==View.GONE) {
                ...
                if(response.code()==201||response.code()==200){
                    ...
                    if(queuelist.size()!=0){
                        for(int i=0;i<queuelist.size();i++){
                            if(queuelist.get(i).getStatus().equals("accepted")&&queuelist.get(i).getOrder_detail()!=null){
        ...
        (RetrofitClientInstance.getApiService().RestaurantgetHeader("Bearer "+sessionManager.getACCESSTOKEN())).enqueue(new Callback<Header>() {
            ...
            public void onResponse(@NonNull Call<Header> call, @NonNull Response<Header> response) {
                ...
                if(response.code()==202||response.code()==200){
                   ...
                   Resturant_Tablet_MainActivity.availabletrolley.setText(String.valueOf(login.getData().getNew_order()));
...
*/
        ...
        (RetrofitClientInstance.getApiService().RestaurantOrderAccepted(BuildConfig.restaurant_order_accept+id,"Bearer "+sessionManager.getACCESSTOKEN())).enqueue(new Callback<Action>() {
            @Override
...
*/
        ...
        (RetrofitClientInstance.getApiService().RestaurantOrderDispatched(BuildConfig.restaurant_order_dispatch+id,"Bearer "+sessionManager.getACCESSTOKEN())).enqueue(new Callback<Action>() {
            @Override
            public void onResponse(@NonNull Call<Action> call, @NonNull Response<Action> response) {
...
*/
        ...
        (RetrofitClientInstance.getApiService().RestaurantOrderCleared(BuildConfig.restaurant_order_clear+id,"Bearer "+sessionManager.getACCESSTOKEN())).enqueue(new Callback<Action>() {
            @Override
            public void onResponse(@NonNull Call<Action> call, @NonNull Response<Action> response) {
    ...
    public class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.viewholder> {
        ...
        public HomeAdapter(Context context,ArrayList<RestaurantApp_Dashboard.Data> homeViewModels) {
        ...
        public HomeAdapter.viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.queuelist_tablet, parent, false);
        ...
        public void onBindViewHolder(@NonNull final HomeAdapter.viewholder holder, final int position) {
            ...
            if(holder.mitem.getStatus().equals("New Order")){
                ...
                holder.dispatch.setText("DISPATCHED");
            ...
            holder.dispatch.setOnClickListener(new View.OnClickListener() {
                ...
                @Override
                public void onClick(View v) {
                    if(holder.mitem.getStatus().equals("In Kitchen")) {
                        if(Network.isNetworkAvailable(getActivity())){
                        //    holder.stop();
            ...
            holder.parent.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    // dialog.getWindow().setLayout(WindowManager.LayoutParams.FILL_PARENT, WindowManager.LayoutParams.FILL_PARENT);            dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
                    dialog.setContentView(R.layout.detail_popup_tablet);
                            ...
                            if(holder.mitem.getStatus().equals("In Kitchen")){
                                if(Network.isNetworkAvailable(getActivity())){
                                   ...
                                   // setDispatch(holder.mitem.getOrder_detail().getOrder_id(),position);
                                    ...
                                    setDispatch(holder.mitem.getOrder_detail().getOrder_id(),position);
                                   // setD(holder.mitem.getOrder_detail().getOrder_id(),position);
        ...
        public void filterList(ArrayList<RestaurantApp_Dashboard.Data> filterdNames) {
        ...
        public class viewholder extends RecyclerView.ViewHolder {
            ...
            RestaurantApp_Dashboard.Data mitem;
            ...
            public void setData(RestaurantApp_Dashboard.Data item) {
                mitem = item;
        ...
        public class Order_ItemAdapter1 extends  RecyclerView.Adapter<Order_ItemAdapter1.ViewHolder>{
            ArrayList<RestaurantApp_Dashboard.Order_menu_items> order_items;
            Context context;
            ArrayList<RestaurantApp_Dashboard.order_menu_addons> menuItems;
            String room;
            String guests1;
            String ordercreated;
            String description;
            ...
            String status;
            int position1;
            public Order_ItemAdapter1(String room,String guests1,String ordercreated,String description,String orderaccepted,String id,int position1,String status,String dispatchat1,ArrayList<RestaurantApp_Dashboard.Order_menu_items> order_items, Context context) {
            ...
            public class ViewHolder extends RecyclerView.ViewHolder {
                TextView name;
                TextView quantity;
                RestaurantApp_Dashboard.Order_menu_items mitem;
                ...
                public ViewHolder(@NonNull View itemView) {
                    ...
                    itemView.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if(dispatchat1!=null){
                                dispachedat.setText(getDate1(dispatchat1));
                            }
                            else{
                                dispachedat.setText("-");
        ...
        public class AddonsAdatpter extends  RecyclerView.Adapter<AddonsAdatpter.ViewHolder>{
            ArrayList<RestaurantApp_Dashboard.Order_addons> order_items;
            Context context;

            public AddonsAdatpter(ArrayList<RestaurantApp_Dashboard.Order_addons> order_items, Context context) {
                this.order_items = order_items;
                this.context = context;
            }
            ...
            public class ViewHolder extends RecyclerView.ViewHolder {
                ...
                RestaurantApp_Dashboard.Order_addons mitem;
        ...
        public class Order_ItemAdapterdetail extends  RecyclerView.Adapter<Order_ItemAdapterdetail.ViewHolder>{
            ...
            public Order_ItemAdapterdetail(ArrayList<RestaurantApp_Dashboard.Order_menu_items> order_items, Context context) {
                this.order_items = order_items;
                this.context = context;
            }
