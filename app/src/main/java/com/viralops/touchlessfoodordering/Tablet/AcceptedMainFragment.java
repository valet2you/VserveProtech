package com.viralops.touchlessfoodordering.Tablet;
...
public class AcceptedMainFragment extends Fragment implements View.OnClickListener {
        private Ringtone r;
        ...
        public static AcceptedMainFragment newInstance() {
            return new AcceptedMainFragment();
        }
        ...
        public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
            ...
            try {
                IRdMainActivity.neworderss.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (queuelist.size() != 0) {
                            try {
                                if(IRdMainActivity.imgBell.getVisibility()==v.VISIBLE) {
            ...
            shimmerRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
                ...
                public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                    if(IRdMainActivity.imgBell.getVisibility()==View.GONE) {
                    ...
                    if(response.code()==201||response.code()==200){
                        ...
                        if(queuelist.size()!=0){
                            for(int i=0;i<queuelist.size();i++){
                                if(queuelist.get(i).getStatus().equals("accepted")){
                                    ...
                                    System.out.println("current date" + timeStamp + " " + queuelist.get(i).getOrder_detail().getAccepted_at());
            ...
            (RetrofitClientInstance.getApiService().getHeader("Bearer "+sessionManager.getACCESSTOKEN())).enqueue(new Callback<Header>() {
                ...
                public void onResponse(@NonNull Call<Header> call, @NonNull Response<Header> response) {
                    ...
                    if(response.code()==202||response.code()==200){
                        ...
                        IRdMainActivity.availabletrolley.setText(String.valueOf(login.getData().getNew_order()));
                        IRdMainActivity.availabletray.setText(String.valueOf(login.getData().getAccepted_order()));
                        IRdMainActivity.availableassciate.setText(String.valueOf(login.getData().getDispatched_order()));
                        IRdMainActivity.totalorders.setText(String.valueOf(login.getData().getNew_order()+login.getData().getAccepted_order()+login.getData().getCleared_order()));
...
*/
    ...
    public void onClick(View v) {
        ...
        if(v.getId()== R.id.diaptachedorders){
            ...
            getActivity().getSupportFragmentManager().beginTransaction()
                    .replace(R.id.content_view, DispatchedMainFragment.newInstance())
                    .commitNow();
        }
                        ...
                        dispatchbutton.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                    if(Network.isNetworkAvailable(getActivity())){
                                        ...
                                        setDispatch(id,getAdapterPosition());
