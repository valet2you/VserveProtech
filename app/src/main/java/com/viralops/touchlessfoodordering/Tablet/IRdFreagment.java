...
public class IRdFreagment extends Fragment implements View.OnClickListener {
    private Ringtone r;
    ...
    public static IRdFreagment newInstance() {
        return new IRdFreagment();
    }
...
*/
    ...
    public void onClick(View v) {
        ...
        if(v.getId()== R.id.acceptedorder){
            ...
            disptachedcount.setTextColor(getResources().getColor(R.color.gray));
            getActivity().getSupportFragmentManager().beginTransaction()
                    .replace(R.id.content_view, AcceptedMainFragment.newInstance())
                    .commitNow();
        }
