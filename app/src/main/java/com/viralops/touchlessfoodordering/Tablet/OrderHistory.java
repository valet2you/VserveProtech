...
*/
        ...
        (RetrofitClientInstance.getApiService().getHistory("Bearer "+sessionManager.getACCESSTOKEN(),show)).enqueue(new Callback<com.viralops.touchlessfoodordering.Model.OrderHistory>() {
            @Override
            public void onResponse(@NonNull Call<com.viralops.touchlessfoodordering.Model.OrderHistory> call, @NonNull Response<com.viralops.touchlessfoodordering.Model.OrderHistory> response) {

                if(response.code()==201||response.code()==200){
                    com.viralops.touchlessfoodordering.Model.OrderHistory login = response.body();
                    orderslist=new ArrayList<>();
            ...
            @Override
            public void onFailure(@NonNull Call<com.viralops.touchlessfoodordering.Model.OrderHistory> call, @NonNull Throwable t) {
    ...
    private void filter(String text) {
        try {
            ...
            ArrayList<com.viralops.touchlessfoodordering.Model.OrderHistory.Data> filterdNames = new ArrayList<>();

            //looping through existing elements
            for (com.viralops.touchlessfoodordering.Model.OrderHistory.Data s : orderslist) {
