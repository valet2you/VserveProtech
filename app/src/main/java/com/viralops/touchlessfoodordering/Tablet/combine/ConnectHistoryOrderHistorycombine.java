...
import com.viralops.touchlessfoodordering.Tablet.AYS.ConnectHistoryAdapter;
import com.viralops.touchlessfoodordering.Tablet.AYS.ConnectHistoryOrderHistory;
...
public class ConnectHistoryOrderHistorycombine extends Fragment {
    ...
    TextView norecord;
    ArrayList<ConnectHistory.Data> orderslist;
    SessionManager sessionManager;
    AutoCompleteTextView searchView;
    ConnectHistoryAdapter homeAdapter;
    ImageView filter;
    public static ConnectHistoryOrderHistory newInstance() {
        return new ConnectHistoryOrderHistory();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        View view= inflater.inflate(R.layout.connect_history_fragment, container, false);
        ...
        homeAdapter=new ConnectHistoryAdapter(getActivity(),orderslist);
...
*/
    ...
    private void filter(String text) {
        try {
            ...
            for (ConnectHistory.Data s : orderslist) {
