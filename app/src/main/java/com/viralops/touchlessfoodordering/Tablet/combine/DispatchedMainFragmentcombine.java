...
public class DispatchedMainFragmentcombine extends Fragment implements View.OnClickListener {
        private Ringtone r;
        ...
        public static DispatchedMainFragmentcombine newInstance() {
            return new DispatchedMainFragmentcombine();
        }
