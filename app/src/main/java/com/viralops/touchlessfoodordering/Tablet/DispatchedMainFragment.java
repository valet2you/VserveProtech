...
public class DispatchedMainFragment extends Fragment implements View.OnClickListener {
        private Ringtone r;
        ...
        public static DispatchedMainFragment newInstance() {
            return new DispatchedMainFragment();
        }
