...
public class AcceptedMainFragmentcombine extends Fragment implements View.OnClickListener {
        private Ringtone r;
        ...
        public static AcceptedMainFragmentcombine newInstance() {
            return new AcceptedMainFragmentcombine();
        }
